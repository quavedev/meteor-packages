...
if (Meteor.isClient) {
  ...
  Tinytest.addAsync(
    'issue #67 - hooks should get called when mutation method called in a tight loop',
    function (test, next) {
      let c1 = 0;
      let c2 = 0;
      ...
      InsecureLogin.ready(function () {
        Meteor.call(
          'test_hooks_in_loop_reset_collection',
          function (nil, result) {
            function start(id) {
            ...
            collection.insert(
              { times: 0, client_counter: 0, server_counter: 0 },
              function (nil, id) {
                start(id);
              }
            );
