...
Tinytest.addAsync(
  'remove - local collection document should affect external variable before being removed',
  function (test, next) {
...
Tinytest.addAsync(
  'remove - local collection should fire after-remove hook and affect external variable',
  function (test, next) {
    const collection = new Mongo.Collection(null);
    let external = 0;
