...
Tinytest.addAsync(
  'update - server collection documents should have extra properties added before and after being updated despite selector not being _id',
  function (test, next) {
    ...
    collection.insert({ not_an_id: 'testing' }, function (err, id1) {
      ...
      collection.insert({ not_an_id: 'testing' }, function (err, id2) {
        ...
        collection.insert({ not_an_id: 'testing' }, function (err, id3) {
          ...
          collection.update(
            { not_an_id: 'testing' },
            { $set: { not_an_id: 'newvalue', test: true } },
            { multi: true }
          );
