...
Tinytest.addAsync(
  'try-catch - should call error callback on insert hook exception',
  function (test, next) {
...
Tinytest.addAsync(
  'try-catch - should call error callback on update hook exception',
  function (test, next) {
    const collection = new Mongo.Collection(null);
...
Tinytest.addAsync(
  'try-catch - should call error callback on remove hook exception',
  function (test, next) {
    const collection = new Mongo.Collection(null);
