Tinytest.add('Slingshot - AWS S3 - Signature', function (test) {
  ...
  var AWSSecretAccessKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY',
    policy =
      'eyAiZXhwaXJhdGlvbiI6ICIyMDEzLTA4LTA3VDEyOjAwOjAwLjAwMFoiLA0KI' +
  ...
  var signature = Slingshot.S3Storage.signAwsV4(
    policy,
    AWSSecretAccessKey,
    '20130806',
    'us-east-1',
  ...
  test.equal(
    signature,
    '21496b44de44ccb73d545f1a995c68214c9cb0d41c45a17a5dae' + 'ec0b1a6db047'
  );
});
